...
import { positionStyle, withOpacity } from "./overlay-style.ts";
...
assert.deepEqual(positionStyle("top-left", 40), {
  top: 40,
  bottom: undefined,
  left: 40,
  right: undefined,
...
assert.deepEqual(positionStyle("bottom-right", 0), {
  top: undefined,
  bottom: 0,
  left: undefined,
  right: 0,
...
assert.deepEqual(positionStyle("center", 40), {
  top: "50%",
  bottom: undefined,
  left: "50%",
  right: undefined,
...
assert.deepEqual(positionStyle("top-center", 24), {
  top: 24,
  bottom: undefined,
  left: "50%",
  right: undefined,
...
assert.deepEqual(positionStyle("center-right", 24), {
  top: "50%",
  bottom: undefined,
  left: undefined,
  right: 24,
